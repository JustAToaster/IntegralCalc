...
cl_event vecinit(cl_kernel vecinit_k, cl_command_queue que,
	...
	cl_uint seed3, cl_uint seed4, int nsamples){
...
cl_event intcalc(cl_kernel intcalc_k, cl_command_queue que,
	...
	const size_t gws[] = { nsamples/4 };	//there are nsamples-1 rectangles though, gotta be careful with the last work-item
...
int main(int argc, char* argv[]){
	...
	cl_kernel intcalc_k = clCreateKernel(prog, "intcalc_randrect4", &err);
